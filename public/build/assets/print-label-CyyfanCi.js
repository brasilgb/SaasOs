import{r,j as i}from"./vendor-CrPKImjE.js";const s={0:"101001101101",1:"110100101011",2:"101100101011",3:"110110010101",4:"101001101011",5:"110100110101",6:"101100110101",7:"101001011011",8:"110100101101",9:"101100101101"};function o(e){const t=String(e||"").replace(/\D/g,"");return t?t.slice(0,12):`${Date.now()}`.slice(-12)}function d({value:e}){const t=`1010${e.split("").map(n=>s[n]??s[0]).join("00")}101`;return i.jsx("div",{className:"part-barcode","aria-label":`Codigo de barras ${e}`,children:t.split("").map((n,a)=>i.jsx("span",{className:n==="1"?"bar on":"bar off"},`${e}-${a}`))})}function l({part:e}){const t=o((e==null?void 0:e.reference_number)??"");return r.useEffect(()=>{const n=window.setTimeout(()=>{window.print()},300);return()=>window.clearTimeout(n)},[]),i.jsxs("div",{className:"bg-white text-black",children:[i.jsx("style",{children:`
                @page {
                    size: 60mm 40mm;
                    margin: 0;
                }
