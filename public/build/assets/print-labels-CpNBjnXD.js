import{r as h,j as e}from"./vendor-616b0WND.js";const p=(a,i)=>{const l=[];for(let r=0;r<a.length;r+=i)l.push(a.slice(r,r+i));return l},x={0:"101001101101",1:"110100101011",2:"101100101011",3:"110110010101",4:"101001101011",5:"110100110101",6:"101100110101",7:"101001011011",8:"110100101101",9:"101100101101"};function b({value:a}){const i=`1010${a.split("").map(l=>x[l]??x[0]).join("00")}101`;return e.jsx("div",{className:"thermal-barcode","aria-label":`Codigo de barras ${a}`,children:i.split("").map((l,r)=>e.jsx("span",{className:l==="1"?"bar on":"bar off"},`${a}-${r}`))})}function u({data:a,format:i="a4"}){const l=h.useRef(null),r=Array.isArray(a)?a:[],g=p(r,96),f=i==="thermal";return h.useEffect(()=>{const t=window.setTimeout(()=>{window.print()},300);return()=>window.clearTimeout(t)},[]),e.jsx("div",{ref:l,className:"bg-white text-black",children:f?e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
                        @page {
                            size: 60mm 40mm;
                            margin: 0;
                        }
