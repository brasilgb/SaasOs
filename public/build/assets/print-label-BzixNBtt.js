import{r,j as i}from"./vendor-MXWfZosQ.js";const o={0:"101001101101",1:"110100101011",2:"101100101011",3:"110110010101",4:"101001101011",5:"110100110101",6:"101100110101",7:"101001011011",8:"110100101101",9:"101100101101"};function a(e){const t=String(e||"").replace(/\D/g,"");return t?t.slice(0,12):`${Date.now()}`.slice(-12)}function l({value:e}){const t=`1010${e.split("").map(s=>o[s]??o[0]).join("00")}101`;return i.jsx("svg",{className:"part-barcode",viewBox:`0 0 ${t.length} 40`,preserveAspectRatio:"none","aria-label":`Codigo de barras ${e}`,children:t.split("").map((s,n)=>s==="1"?i.jsx("rect",{x:n,y:"0",width:"1",height:"40",fill:"#000"},`${e}-${n}`):null)})}function c({part:e}){const t=a(String((e==null?void 0:e.reference_number)??""));return r.useEffect(()=>{const s=window.setTimeout(()=>{window.print()},300);return()=>window.clearTimeout(s)},[]),i.jsxs("div",{className:"bg-white text-black",children:[i.jsx("style",{children:`
                @page {
                    size: 60mm 40mm;
                    margin: 0;
                }
