                    ...
                    <form onSubmit={handleSubmit} autoComplete="off" className="space-y-8">
                        <div className="mt-4 grid gap-4 md:grid-cols-5">
                            <div className="grid gap-2 md:col-span-2">
                                ...
                                />
                                {errors.tenant_id && <div className="text-sm text-red-500">{errors.tenant_id}</div>}
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    maxLength={18}
                                />
                                {errors.branch_cnpj && <div className="text-sm text-red-500">{errors.branch_cnpj}</div>}
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                />
                                {errors.branch_number && <div className="text-sm text-red-500">{errors.branch_number}</div>}
                            </div>
                        </div>
                        ...
                        <div className="mt-4 grid gap-4 md:grid-cols-6">
                            <div className="grid gap-2 md:col-span-2">
                                ...
                                />
                                {errors.contact_name && <div className="text-sm text-red-500">{errors.contact_name}</div>}
                            </div>
                            ...
                            <div className="grid gap-2 md:col-span-2">
                                ...
                                />
                                {errors.contact_email && <div className="text-sm text-red-500">{errors.contact_email}</div>}
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    maxLength={15}
                                />
                                {errors.contact_phone && <div className="text-sm text-red-500">{errors.contact_phone}</div>}
                            </div>
