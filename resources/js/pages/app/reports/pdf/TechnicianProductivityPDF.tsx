...
export default function TechnicianProductivityPDF({ data, company }: any) {
    ...
    const completedOrders = data.filter(
        (o: any) => o.service_status === 6 || o.service_status === 7
    );

    const deliveredOrders = data.filter(
        (o: any) => o.service_status === 8
    );
        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.table}>
                    ...
                    {rows.map((row: any, index: number) => (
                        <View key={index} style={styles.row}>
                            ...
                            <Text style={styles.colMoney}>
                                R$ {maskMoney(String(row.ticketMedio))}
                            </Text>
                ...
                <View style={styles.footer}>
                    ...
                    <Text>
                        Total faturado em serviços: R$ {maskMoney(String(totalServicos))}
                    </Text>
                </View>
                ...
                <View style={styles.metricsBox}>
                    ...
                    <Text style={styles.metricTitle}>
                        Indicadores de Tempo de Reparo
                    </Text>

                    <Text>
                        Tempo médio para concluir serviço: {avgRepairDays.toFixed(1)} dias
                    </Text>

                    <Text>
                        Tempo médio até entrega: {avgDeliveryDays.toFixed(1)} dias
                    </Text>

                    <Text>
                        Equipamentos pendentes há mais de 7 dias: {pendingLongTime}
                    </Text>
