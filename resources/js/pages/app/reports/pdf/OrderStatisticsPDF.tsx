...
export default function OrderStatisticsPDF({ data, dateRange, company }: any) {
  ...
  const totalServicos = data.reduce(
    (acc:number, o:any) => acc + Number(o.service_value || 0),
    0
  );

  const totalPecas = data.reduce(
    (acc:number, o:any) => acc + Number(o.parts_value || 0),
    0
  );
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.subtitle}>
          Resumo Geral de Ordens de Serviço
        </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.colRight}>
              R$ {maskMoney(String(totalServicos))}
            </Text>
          </View>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.total}>
            Total de ordens analisadas: {stats.total}
          </Text>
        </View>
