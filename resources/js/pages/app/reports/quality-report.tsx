...
import QualityReportPDF from './pdf/QualityReportPDF';
...
export default function QualityReport({ dateRange, company }: { dateRange?: DateRange; company: string }) {
        ...
        router.post(
            ...
            },
            {
                ...
                onSuccess: async (page: any) => {
                    ...
                    const blob = await pdf(<QualityReportPDF data={reportData} reportMeta={reportMeta} dateRange={dateRange} company={company} />).toBlob();
