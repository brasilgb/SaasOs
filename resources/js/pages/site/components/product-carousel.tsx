...
const products: Product[] = [
    ...
    },
    {
        ...
        description: 'Visualize faturamento, vendas, despesas e indicadores financeiros em um só painel.',
        image: '/images/slide/2.png',
    },
    {
        id: 3,
        title: 'Gestão de clientes',
        description: 'Organize sua base de clientes com histórico, contatos e equipamentos vinculados.',
        image: '/images/slide/3.png',
    },
    {
        id: 4,
        title: 'Controle de caixa e despesas',
        description: 'Registre entradas, despesas e movimentações no caixa diário com mais segurança.',
