...
<head>
    ...
    <title>Como está sua experiência com o VetorOS?</title>
</head>
...
<body style="margin:0;padding:0;background:#f3f4f6;font-family:Arial,Helvetica,sans-serif;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
        Sua resposta leva menos de 1 minuto e ajuda nossa equipe a melhorar o VetorOS.
    </div>
                ...
                <table width="600" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td align="center" style="background:#0f172a;padding:30px 20px;">
                            ...
                            @else
                                <h1 style="margin:0;color:#ffffff;font-size:24px;letter-spacing:0.5px;"><span style="color:#ffffff;">Vetor</span><span style="color:#00B4FF;">OS</span></h1>
                            @endif
                    ...
                    <tr>
                        <td style="padding:36px;color:#374151;">
                            <h2 style="margin-top:0;font-size:20px;color:#111827;">Como está sua experiência com o VetorOS?</h2>
                            ...
                            <p style="font-size:14px;line-height:1.7;color:#4b5563;margin:20px 0 0 0;">
                                Se preferir, você também pode responder quando entrar no dashboard do VetorOS. Vamos deixar esse convite visível por
