...
<head>
    ...
    <title>Atualizacao da sua solicitacao no SigmaOS</title>
</head>
...
<body style="margin:0;padding:0;background:#f3f4f6;font-family:Arial,Helvetica,sans-serif;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;">
        Sua solicitacao no SigmaOS recebeu uma atualizacao da equipe.
    </div>
                    ...
                    <tr>
                        <td style="padding:36px;color:#374151;">
                            ...
                            <p style="font-size:14px;line-height:1.7;margin:24px 0 0 0;color:#4b5563;">
                                Voce pode acompanhar essa solicitacao pelo painel do SigmaOS na area de ajustes.
                            </p>
                        </td>
                    </tr>
                    <tr>
